class SearchFiveDaysModel {
  ...
  final List<FiveDayForecast>? list;
  ...
  factory SearchFiveDaysModel.fromJson(Map<String, dynamic> json) =>
      SearchFiveDaysModel(
        list: (json["list"] as List<dynamic>?)!
            .map((item) =>
                FiveDayForecast.fromJson(item as Map<String, dynamic>))
            .toList(),
        city: json["city"],
  ...
  List<FiveDayForecast> getPerHourForecast() {
    final List<FiveDayForecast> perHourList = list!
